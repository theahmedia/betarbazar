...
const Review = () => {
  ...
  return (
    ...
    >
      <h1 className="text-3xl font-bold text-center mb-12">Client Reviews</h1>
      
      <div className="relative">
        <div className="flex items-center justify-center">
          <button 
            onClick={prevSlide}
            className="absolute -left-4 z-10 p-2 rounded-full bg-gray-100 hover:bg-gray-200 transition duration-300"
          >
                ...
                >
                  <div className="bg-white rounded-lg shadow-lg p-6 h-full mx-2">
                    <div className="flex flex-col items-center">
                      ...
                      <h3 className="font-semibold text-lg md:text-base mb-1">{review.name}</h3>
                      <p className="text-gray-600 text-base md:text-sm mb-1">{review.occupation}</p>
                      <p className="text-gray-500 text-base md:text-sm">{review.location}</p>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <button 
            onClick={nextSlide}
            className="absolute -right-4 z-10 p-2 rounded-full bg-gray-100 hover:bg-gray-200 transition duration-300"
          >

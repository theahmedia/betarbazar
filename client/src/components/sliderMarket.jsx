          ...
          return (
            <div key={index} className="relative w-full">
              ...
              <div className={`absolute inset-0 flex flex-col ${alignment} justify-center p-6 sm:p-8 lg:p-28`}>
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 sm:mb-2">{t(title)}</h2>
                <p className="text-sm sm:text-md md:text-lg max-w-60 sm:max-w-full mb-2 sm:mb-4">{t(description)}</p>
                <a
                  href={link}
